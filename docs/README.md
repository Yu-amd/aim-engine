...
- **Orchestrated Mode**: Manages separate containers for each model
- **Unified Mode**: Single container with both orchestration and serving
- **Direct Mode**: Direct vLLM serving without orchestration
